// assigning variable playlist elements 
...
// utilizing audio web api to play songs
const audio = new Audio ();

// store object to keep track of songs, current song & duration 
let userData = {
  songs: [...allSongs],
  currentSong: null,
  songCurrentTime: 0,
...
// add music player shuffle for songs
const shuffle = () => {
...
const deleteSong = (id) => {
  ...
  if (userData?.songs.length === 0) {
    ...
    // add elements as children of parent elements
